    ...
    return (
      <section>
        <div>
           ...
           {/* Main section */}
             <div class="-mt-52 md:p-52 md:-mb- p-48 w-screen -ml- md:flex bg-white">
                    <div>
                    <Image src="/services-img (1).jpg" width={5000} height={100} class="ml-40 -mr- w-screen" alt="" />
                    </div>

                <div class="bg-red-600 space-y-10 pt-20 pb-20 -mt-10 w-96 -ml-48 md:w-11/12 md:-mt-28 md:-ml-16">
                   <div class="md:mr-52 md:ml-20 pt-5 pb-5 -ml-36 text-white">
             ...
             {/* Service 1 */}
            <div class="-mt-80 md:p-52 md:mb-20 p-48 w-screen -ml- md:space-y-20 bg-white">
                <div class="md:flex md:space-x-20">
                  <div class="md:space-y-5">
                     ...
                     <div class="">
                      <h1 class="font-bold text-4xl">Planning</h1>
                     </div>
                     <hr class="line4" />
                     <div class="">
                       <p class="">
                  ...
                  <div class="md:space-y-5">
                    ...
                    <div class="">
                      <h1 class="font-bold text-4xl">Project Management</h1>
                    </div>
                    <hr class="line4" />
                    <div class="">
                      <p class="">
                 ...
                 <div class="md:flex md:space-x-20">
                  <div class="md:space-y-5">
                     ...
                     <div class="">
                      <h1 class="font-bold text-4xl">Structural Engineering</h1>
                     </div>
                     <hr class="line4" />
                     <div class="">
                       <p class="">
                  ...
                  <div class="md:space-y-5">
                    ...
                    <div class="">
                      <h1 class="font-bold text-4xl">Interior Design</h1>
                    </div>
                    <hr class="line4" />
                    <div class="">
                      <p class="">
                ...
                <div class="md:flex md:space-x-20">
                  <div class="md:space-y-5">
                     ...
                     <div class="">
                      <h1 class="font-bold text-4xl">Building</h1>
                     </div>
                     <hr class="line4" />
                     <div class="">
                       <p class="">
                  ...
                  <div class="md:space-y-5">
                    ...
                    <div class="">
                      <h1 class="font-bold text-4xl">Consultation</h1>
                    </div>
                    <hr class="line4" />
                    <div class="">
                      <p class="">
